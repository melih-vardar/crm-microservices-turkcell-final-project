package com.turkcell.plan_service.config;
...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_ENDPOINTS = {
            ...
            "/swagger-ui/**",
            "/swagger-ui.html",
            "/api/plans/test" // Test endpoint is public
    };

    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        log.info("Configuring security for plan-service");
        ...
        log.info("Security configuration completed for plan-service");
