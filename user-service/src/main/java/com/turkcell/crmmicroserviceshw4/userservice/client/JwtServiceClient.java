package com.turkcell.crmmicroserviceshw4.userservice.client;
...
public interface JwtServiceClient {
    ...
    ResponseEntity<Boolean> invalidateToken(@RequestParam String token);

    @GetMapping("/role")
    ResponseEntity<String> getRoleFromToken(@RequestParam String token);
}