...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_ENDPOINTS = {
            ...
            "/swagger-ui/**",
            "/swagger-ui.html",
            "/api/billings/test" // Test endpoint is public
    };

    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        log.info("Configuring security for billing-service");
        ...
        log.info("Security configuration completed for billing-service");
